import { div, p, ul, li, br } from "../../../../build/tags";
    ...
    return div({ class: "container" }, [
      ...
      ul({}, [
        li({}, [
          "Commands",
          ul({}, [
            li({}, ["Storing and retrieving data from the Database Servers"]),
            li({}, ["Storeing and retriving data from the localStorage"]),
            li({}, [
        ...
        li({}, [
          "Subscriptions",
          ul({}, [
            li({}, ["Subscribing and listening to WebSocket messages"]),
            li({}, ["Listening to Geo Location changes"]),
          ]),
        ]),
      ]),
    ]);
